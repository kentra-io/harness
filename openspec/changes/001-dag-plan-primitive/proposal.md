...
<!-- Bullet list. Call out any brand-new capability and any existing
     capability whose REQUIREMENTS are changing — each needs a
     specs/<capability>/spec.md delta in this change folder
     (spec-lifecycle.md §4, §6.4). -->
